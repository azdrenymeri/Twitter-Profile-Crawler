...
module.exports = function(response){
    ...
    const handle = htmlDoc('a.ProfileHeaderCard-screennameLink.u-linkComplex.js-nav').text();
   ...
   const payload = {htmlDoc,imageUrl,name,handle,bio,followers,following, tweets:[]};
    ...
    htmlDoc('div#timeline>div>div.stream>ol>li').each((i,element) => {
        ...
        const tweetContent = tweetDoc('p.TweetTextSize.TweetTextSize--normal.js-tweet-text.tweet-text').text();
